...
test.describe('Shell Platform Production Site - Comprehensive E2E Testing', () => {
  ...
  test('1. Initial Site Load and Health Check', async ({ page }) => {
    ...
    await page.screenshot({ 
      path: './production-test-results/homepage-initial.png',
      fullPage: true 
    });
  ...
  test('2. Login Flow - Complete Authentication Test', async ({ page }) => {
    ...
    await page.screenshot({ 
      path: './production-test-results/before-login.png',
      fullPage: true 
    });
    ...
    await page.screenshot({ 
      path: './production-test-results/login-form-filled.png',
      fullPage: true 
    });
    ...
    try {
      ...
      await page.screenshot({ 
        path: './production-test-results/after-login.png',
        fullPage: true 
      });
      ...
      await page.screenshot({ 
        path: './production-test-results/login-error.png',
        fullPage: true 
      });
  ...
  test('5. Visual Regression and Mobile Responsiveness', async ({ page, browserName }) => {
    ...
    await page.setViewportSize({ width: 1920, height: 1080 });
    await page.screenshot({ 
      path: `./production-test-results/desktop-${browserName}.png`,
      fullPage: true 
    });
    ...
    await page.screenshot({ 
      path: `./production-test-results/tablet-${browserName}.png`,
      fullPage: true 
    });
    ...
    await page.screenshot({ 
      path: `./production-test-results/mobile-${browserName}.png`,
      fullPage: true 
    });

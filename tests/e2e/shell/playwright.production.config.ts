...
export default defineConfig({
  testDir: '/var/www/tests/e2e/shell/tests',
  ...
  reporter: [
    ['html', { outputFolder: '/var/www/tests/e2e/shell/reports/production-html' }],
    ['json', { outputFile: '/var/www/tests/e2e/shell/reports/production-results.json' }],
    ['junit', { outputFile: '/var/www/tests/e2e/shell/reports/production-results.xml' }],
    ['list'], // Console output
  ],
  ...
  outputDir: '/var/www/tests/e2e/shell/production-test-results/',
